...
def main():
    ...
    parser.add_argument(
        "--algo", type=str, default="dqn", choices=["dqn", "ppo"], help="RL Algorithm"
    )
    parser.add_argument(
        "--scenario",
        type=str,
        default="highway",
        help="Environment scenario (highway, merge, roundabout, etc.)",
    )
    parser.add_argument(
        "--model",
        type=str,
        default="small",
        choices=["small", "large", "custom", "resnet", "vgg"],
    ...
    parser.add_argument(
        "--total_timesteps", type=int, default=10000, help="Total training timesteps"
    )
    parser.add_argument(
        "--save_dir", type=str, default="checkpoints", help="Directory to save models"
    )
    parser.add_argument(
        "--load_path", type=str, default="", help="Path to load model for evaluation"
    )
    parser.add_argument(
